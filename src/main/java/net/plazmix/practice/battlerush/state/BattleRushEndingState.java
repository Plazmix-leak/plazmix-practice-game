...
import net.plazmix.practice.battlerush.scoreboard.BattleRushEndingScoreboard;
...
public class BattleRushEndingState extends StandardEndingState {
    ...
    public BattleRushEndingState(@NonNull GamePlugin plugin) {
    ...
    protected void handleStart() {
        ...
        int wins = PlazmixUser.of(winnerUser.getBukkitHandle()).getDatabaseValue("BattleRush", "Wins");
        // Add player win.
        winnerUser.getCache().set(BattleRushGameConstants.WINS_PLAYER_DATA, wins + 1);
        ...
        GameMysqlDatabase statsMysqlDatabase = plugin.getService().getGameDatabase(BattleRushGameStatsMysqlDatabase.class);
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            // Player data insert
            winnerUser.getCache().increment(BattleRushGameConstants.GAMES_PLAYED_PLAYER_DATA);
    ...
    protected void handleScoreboardSet(@NonNull Player player) {
        new BattleRushEndingScoreboard(player);
    }
