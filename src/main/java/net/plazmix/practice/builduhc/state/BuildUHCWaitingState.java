...
import net.plazmix.practice.builduhc.scoreboard.BuildUHCWaitingScoreboard;
...
public class BuildUHCWaitingState extends StandardWaitingState {
    ...
    public BuildUHCWaitingState(@NonNull GamePlugin plugin) {
    ...
    protected void handleEvent(@NonNull PlayerJoinEvent event) {
        ...
        GameSchedulers.runLater(10, () -> {
            ...
            new BuildUHCWaitingScoreboard(getTimerStatus(), event.getPlayer());
    ...
    @Override
    protected void handleTimerUpdate(@NonNull StandardWaitingState.TimerStatus timerStatus) {
