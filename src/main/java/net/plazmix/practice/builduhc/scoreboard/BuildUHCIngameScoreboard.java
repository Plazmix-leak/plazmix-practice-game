package net.plazmix.practice.builduhc.scoreboard;
...
public class BuildUHCIngameScoreboard {
    public BuildUHCIngameScoreboard(@NonNull Player player) {
        ...
        scoreboardBuilder.scoreboardLine(6, "§fОппонент: ");
        scoreboardBuilder.scoreboardLine(5, GameUser.from(opponent).getPlazmixHandle().getDisplayName());
