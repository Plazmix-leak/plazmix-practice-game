...
import net.plazmix.practice.gapple.scoreboard.GAppleWaitingScoreboard;
...
public class GAppleWaitingState extends StandardWaitingState {
    ...
    public GAppleWaitingState(@NonNull GamePlugin plugin) {
    ...
    protected void handleEvent(@NonNull PlayerJoinEvent event) {
        ...
        GameSchedulers.runLater(10, () -> {
            ...
            new GAppleWaitingScoreboard(getTimerStatus(), event.getPlayer());
