...
import net.plazmix.practice.nodebuff.scoreboard.NoDebuffEndingScoreboard;
...
public class NoDebuffEndingState extends StandardEndingState {
    ...
    public NoDebuffEndingState(@NonNull GamePlugin plugin) {
    ...
    protected void handleStart() {
        ...
        int wins = PlazmixUser.of(winnerUser.getBukkitHandle()).getDatabaseValue("NoDebuff", "Wins");
        // Add player win.
        winnerUser.getCache().set(NoDebuffGameConstants.NODEBUFF_WINS_PLAYER_DATA, wins + 1);
        ...
        GameMysqlDatabase statsMysqlDatabase = plugin.getService().getGameDatabase(NoDebuffGameStatsMysqlDatabase.class);
            ...
            for (Player player : Bukkit.getOnlinePlayers()) {
                ...
                // Player data insert
                winnerUser.getCache().increment(NoDebuffGameConstants.NODEBUFF_GAMES_PLAYED_PLAYER_DATA);
    ...
    protected void handleScoreboardSet(@NonNull Player player) {
        new NoDebuffEndingScoreboard(player);
    }
